...
Partial Class order
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(order))
        Button6 = New Button()
        Button7 = New Button()
        Button8 = New Button()
        Label7 = New Label()
        ...
        ' TextBox3
        ' 
        TextBox3.Location = New Point(219, 183)
